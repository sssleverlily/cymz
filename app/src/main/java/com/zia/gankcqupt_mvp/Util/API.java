...
public class API {
    ...
    private API(Context context) {
        ...
        root = SharedPreferencesUtil.getSharedPreferences(context).getString("root", "zzzia");
    }
    ...
    public String getCET(String id) {
        if (root.equals("congm")) {
            ...
            String url = "http://zzzia.net/cet/" + id + ".jpg";
            LogUtil.d(TAG, url);
            return url;
        }
    }
    ...
    public String getYKT(String id) {
        if (root.equals("congm")) {
            ...
            String url = "http://zzzia.net/ykt/" + id + ".jpg";
            LogUtil.d(TAG, url);
            return url;
        }
    }
